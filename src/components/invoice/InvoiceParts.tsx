  ...
  return (
    <div className="text-right">
      <div className="inline-flex gap-0">
        <span className="text-[12px] text-black font-bold leading-snug whitespace-nowrap">DL:&nbsp;</span>
        <div className="flex flex-col items-start">
          {filled.map((dl, i) => (
            <span key={i} className="text-[12px] text-black font-bold leading-snug whitespace-nowrap">
              {dl}
            </span>
          ))}
        </div>
